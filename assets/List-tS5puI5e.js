import{r as a,d,l as p,j as e}from"./iframe-BO4zZm_g.js";const c=a.createContext({variant:"standard"}),m=()=>{const o=a.useContext(c);if(!o)throw new Error("List compound components can't be rendered outside List component");return o},f=d.div`
