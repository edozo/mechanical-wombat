import{r as s,j as l,V as je,R as $,d as I,m as W}from"./iframe-B7Hjg5Rr.js";import{r as mt,P as gt}from"./index-k3AUpVb3.js";import{c as se,u as L}from"./index-Bx_RErfz.js";import{E as Le}from"./EdozoLogoV2-D-j9rWA6.js";import{c as ie,L as Z}from"./Lucide-BfT9y3dH.js";import{L as ge}from"./List-DpIW1N6d.js";import{E as ae}from"./EdozoLogo-CGiOhFna.js";import"./preload-helper-C1FmrZbK.js";import"./edozo-logo-j80GRS-N.js";/**
...
]`,computed:!1}},openOnClickOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},user:{required:!1,tsType:{name:"string"},description:"The logged-in user identifier shown in the account dropdown. May be a name or email address."}}};const no={title:"Components/HeaderV2",component:U,argTypes:{user:{description:"Logged-in user identifier (name or email) shown in the account dropdown.",control:{type:"text"}},isAuthenticated:{description:"Whether to show the authenticated menu.",control:{type:"boolean"}}}},H=()=>l.jsx(U,{logoSection:l.jsx(ae,{variant:"edozo",size:"small"}),logout:()=>{}}),V=e=>l.jsx(U,{logoSection:l.jsx("a",{children:l.jsx(ae,{variant:"edozo"})}),isAuthenticated:e.isAuthenticated,logout:e.logout,user:e.user,children:l.jsxs(s.Fragment,{children:[l.jsx(z.Item,{children:l.jsx("a",{className:"active",children:"Help"})}),l.jsx(z.Item,{children:l.jsx("a",{children:"Docs"})})]})});V.args={isAuthenticated:!0,logout:()=>console.log("app specific logout method")};const K=()=>l.jsx(U,{logoSection:l.jsx(Le,{appName:"maps"}),isAuthenticated:!0,logout:()=>{}}),k=e=>l.jsx(U,{logoSection:l.jsx("a",{children:l.jsx(ae,{variant:"edozo"})}),isAuthenticated:!0,logout:e.logout,user:e.user});k.args={logout:()=>console.log("logout"),user:"jane.smith@example.com"};H.__docgenInfo={description:"",methods:[],displayName:"Default"};V.__docgenInfo={description:"",methods:[],displayName:"ControlledAppHeader"};K.__docgenInfo={description:"",methods:[],displayName:"MapsApp"};k.__docgenInfo={description:"",methods:[],displayName:"WithUser"};var Ee,Ce,be;H.parameters={...H.parameters,docs:{...(Ee=H.parameters)==null?void 0:Ee.docs,source:{originalSource:'() => <AppHeaderV2 logoSection={<EdozoLogo variant={"edozo" as LogoVariants} size="small" />} logout={() => {}} />',...(be=(Ce=H.parameters)==null?void 0:Ce.docs)==null?void 0:be.source}}};var Ne,Re,Me;V.parameters={...V.parameters,docs:{...(Ne=V.parameters)==null?void 0:Ne.docs,source:{originalSource:`args => <AppHeaderV2 logoSection={<a>
