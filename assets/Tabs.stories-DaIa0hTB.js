import{r as T,l as c,d as p,j as a}from"./iframe-D_ylYApI.js";import{B as D}from"./Badge-Dxm4Qgpv.js";import"./preload-helper-C1FmrZbK.js";import"./Badge.styles-F5XO_5DW.js";const h=T.createContext({}),E=h.Provider;h.Consumer;function $(){const t=T.useContext(h);if(!t)throw new Error("Tab compound components can't be rendered outside Tabs component");return t}const L=p.div`
  display: flex;
  ${({$stretch:t})=>t&&c`
