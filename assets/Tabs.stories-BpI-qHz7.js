import{r as T,l as c,d as p,j as a}from"./iframe-CcAdSECF.js";import{B as D}from"./Badge-Bvk3bomG.js";import"./preload-helper-C1FmrZbK.js";import"./Badge.styles-CRFN4bnQ.js";const h=T.createContext({}),E=h.Provider;h.Consumer;function $(){const t=T.useContext(h);if(!t)throw new Error("Tab compound components can't be rendered outside Tabs component");return t}const L=p.div`
  display: flex;
  ${({$stretch:t})=>t&&c`
