import{r as T,l as c,d as p,j as a}from"./iframe-C_eeFh7-.js";import{B as D}from"./Badge-re5_QR34.js";import"./preload-helper-C1FmrZbK.js";import"./Badge.styles-bQlWSTJ0.js";const h=T.createContext({}),E=h.Provider;h.Consumer;function A(){const e=T.useContext(h);if(!e)throw new Error("Tab compound components can't be rendered outside Tabs component");return e}const L=p.div`
  display: flex;
  ${e=>e.$stretch&&c`
