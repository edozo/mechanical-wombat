import{r as c,j as t,c as C,s as g}from"./iframe-Ym7xYKuD.js";import{u as H,P as y,b as j,c as U}from"./index-BTaSxaBx.js";import{R as Y,I as J,c as _}from"./index-DyK7yXOr.js";import{P as Q}from"./index-B9qndMY0.js";import{u as X}from"./index-CRszzP67.js";import{u as Z}from"./index-CFF3_kQT.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B17tC9T8.js";import"./index-DBFNr24N.js";import"./index-BbPyFltH.js";import"./index-B-6lRUjL.js";var $="Tabs",[ee]=U($,[_]),A=_(),[te,S]=ee($),D=c.forwardRef((e,n)=>{const{__scopeTabs:o,value:r,onValueChange:s,defaultValue:l,orientation:i="horizontal",dir:u,activationMode:p="automatic",...m}=e,b=X(u),[d,T]=H({prop:r,onChange:s,defaultProp:l??"",caller:$});return t.jsx(te,{scope:o,baseId:Z(),value:d,onValueChange:T,orientation:i,dir:b,activationMode:p,children:t.jsx(y.div,{dir:b,"data-orientation":i,...m,ref:n})})});D.displayName=$;var L="TabsList",N=c.forwardRef((e,n)=>{const{__scopeTabs:o,loop:r=!0,...s}=e,l=S(L,o),i=A(o);return t.jsx(Y,{asChild:!0,...i,orientation:l.orientation,dir:l.dir,loop:r,children:t.jsx(y.div,{role:"tablist","aria-orientation":l.orientation,...s,ref:n})})});N.displayName=L;var E="TabsTrigger",P=c.forwardRef((e,n)=>{const{__scopeTabs:o,value:r,disabled:s=!1,...l}=e,i=S(E,o),u=A(o),p=B(i.baseId,r),m=F(i.baseId,r),b=r===i.value;return t.jsx(J,{asChild:!0,...u,focusable:!s,active:b,children:t.jsx(y.button,{type:"button",role:"tab","aria-selected":b,"aria-controls":m,"data-state":b?"active":"inactive","data-disabled":s?"":void 0,disabled:s,id:p,...l,ref:n,onMouseDown:j(e.onMouseDown,d=>{!s&&d.button===0&&d.ctrlKey===!1?i.onValueChange(r):d.preventDefault()}),onKeyDown:j(e.onKeyDown,d=>{[" ","Enter"].includes(d.key)&&i.onValueChange(r)}),onFocus:j(e.onFocus,()=>{const d=i.activationMode!=="manual";!b&&!s&&d&&i.onValueChange(r)})})})});P.displayName=E;var k="TabsContent",O=c.forwardRef((e,n)=>{const{__scopeTabs:o,value:r,forceMount:s,children:l,...i}=e,u=S(k,o),p=B(u.baseId,r),m=F(u.baseId,r),b=r===u.value,d=c.useRef(b);return c.useEffect(()=>{const T=requestAnimationFrame(()=>d.current=!1);return()=>cancelAnimationFrame(T)},[]),t.jsx(Q,{present:s||b,children:({present:T})=>t.jsx(y.div,{"data-state":b?"active":"inactive","data-orientation":u.orientation,role:"tabpanel","aria-labelledby":p,hidden:!T,id:m,tabIndex:0,...i,ref:n,style:{...e.style,animationDuration:d.current?"0s":void 0},children:T&&l})})});O.displayName=k;function B(e,n){return`${e}-trigger-${n}`}function F(e,n){return`${e}-content-${n}`}var ae=D,ne=N,re=P,se=O;const oe=C(ae)`
  display: flex;
...
`,M=c.createContext(null),z=()=>{const e=c.useContext(M);if(!e)throw new Error("TabsV2 sub-components must be used inside a TabsV2 root");return e},I=c.forwardRef(({defaultValue:e,value:n,onValueChange:o,orientation:r="horizontal",appearance:s="underline",children:l,...i},u)=>{const p=c.useMemo(()=>({appearance:s}),[s]);return t.jsx(M.Provider,{value:p,children:t.jsx(oe,{ref:u,defaultValue:e,value:n,onValueChange:o,orientation:r,...i,children:l})})});I.displayName="TabsV2";const q=c.forwardRef(({stretch:e,children:n,...o},r)=>{const{appearance:s}=z();return t.jsx(le,{ref:r,$stretch:e,$appearance:s,...o,children:n})});q.displayName="TabsV2.List";const G=c.forwardRef(({value:e,disabled:n,children:o,...r},s)=>{const{appearance:l}=z();return t.jsx(de,{ref:s,value:e,disabled:n,$appearance:l,...r,children:o})});G.displayName="TabsV2.Trigger";const K=c.forwardRef(({value:e,children:n,...o},r)=>t.jsx(be,{ref:r,value:e,...o,children:n}));K.displayName="TabsV2.Content";const a=Object.assign(I,{List:q,Trigger:G,Content:K});I.__docgenInfo={description:"",methods:[],displayName:"TabsV2",props:{defaultValue:{required:!1,tsType:{name:"string"},description:"The tab value to activate on first render (uncontrolled)."},value:{required:!1,tsType:{name:"string"},description:"The controlled active tab value."},onValueChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:"Called when the active tab changes."},orientation:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:"Tab orientation.",defaultValue:{value:"'horizontal'",computed:!1}},appearance:{required:!1,tsType:{name:"union",raw:"'underline' | 'pill' | 'boxed' | 'subtle'",elements:[{name:"literal",value:"'underline'"},{name:"literal",value:"'pill'"},{name:"literal",value:"'boxed'"},{name:"literal",value:"'subtle'"}]},description:"Visual style of the tab list and triggers.",defaultValue:{value:"'underline'",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Tab content."}}};const{expect:w,userEvent:R,within:ue}=__STORYBOOK_MODULE_TEST__,W=["underline","pill","boxed","subtle"],je={title:"Components/TabsV2",component:a,argTypes:{defaultValue:{description:"Initially active tab value.",control:{type:"text"}},appearance:{description:"Visual style of the tab list and triggers.",control:{type:"select"},options:W}},args:{defaultValue:"tab1",appearance:"underline"}},ge=e=>t.jsxs(a,{...e,children:[t.jsxs(a.List,{children:[t.jsx(a.Trigger,{value:"tab1",children:"Overview"}),t.jsx(a.Trigger,{value:"tab2",children:"Details"}),t.jsx(a.Trigger,{value:"tab3",children:"Settings"})]}),t.jsx(a.Content,{value:"tab1",children:"Overview content"}),t.jsx(a.Content,{value:"tab2",children:"Details content"}),t.jsx(a.Content,{value:"tab3",children:"Settings content"})]}),f=ge.bind({}),h=()=>t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:32},children:W.map(e=>t.jsxs("div",{children:[t.jsx("p",{style:{margin:"0 0 8px",fontFamily:"Inter, sans-serif",fontSize:12,color:"#6B7280"},children:e}),t.jsxs(a,{defaultValue:"tab1",appearance:e,children:[t.jsxs(a.List,{children:[t.jsx(a.Trigger,{value:"tab1",children:"Overview"}),t.jsx(a.Trigger,{value:"tab2",children:"Details"}),t.jsx(a.Trigger,{value:"tab3",children:"Settings"})]}),t.jsx(a.Content,{value:"tab1",children:"Overview content"}),t.jsx(a.Content,{value:"tab2",children:"Details content"}),t.jsx(a.Content,{value:"tab3",children:"Settings content"})]})]},e))}),x=e=>t.jsxs(a,{...e,children:[t.jsxs(a.List,{children:[t.jsx(a.Trigger,{value:"tab1",children:"Active"}),t.jsx(a.Trigger,{value:"tab2",disabled:!0,children:"Disabled"}),t.jsx(a.Trigger,{value:"tab3",children:"Another"})]}),t.jsx(a.Content,{value:"tab1",children:"Active tab content"}),t.jsx(a.Content,{value:"tab3",children:"Another tab content"})]}),V=e=>t.jsxs(a,{...e,children:[t.jsxs(a.List,{stretch:!0,children:[t.jsx(a.Trigger,{value:"tab1",children:"Tab 1"}),t.jsx(a.Trigger,{value:"tab2",children:"Tab 2"}),t.jsx(a.Trigger,{value:"tab3",children:"Tab 3"})]}),t.jsx(a.Content,{value:"tab1",children:"Tab 1 content"}),t.jsx(a.Content,{value:"tab2",children:"Tab 2 content"}),t.jsx(a.Content,{value:"tab3",children:"Tab 3 content"})]}),v=e=>t.jsxs(a,{...e,children:[t.jsxs(a.List,{children:[t.jsx(a.Trigger,{value:"tab1",children:"Tab 1"}),t.jsx(a.Trigger,{value:"tab2",children:"Tab 2"})]}),t.jsx(a.Content,{value:"tab1",children:t.jsx("span",{"data-testid":"content-1",children:"Content 1"})}),t.jsx(a.Content,{value:"tab2",children:t.jsx("span",{"data-testid":"content-2",children:"Content 2"})})]});v.play=async({canvasElement:e})=>{const n=ue(e);w(n.getByTestId("content-1")).toBeInTheDocument(),await R.click(n.getByRole("tab",{name:"Tab 2"})),w(n.getByTestId("content-2")).toBeInTheDocument(),await R.click(n.getByRole("tab",{name:"Tab 1"})),w(n.getByTestId("content-1")).toBeInTheDocument()};h.__docgenInfo={description:"",methods:[],displayName:"AppearanceComparison"};x.__docgenInfo={description:"",methods:[],displayName:"WithDisabledTab"};V.__docgenInfo={description:"",methods:[],displayName:"Stretched"};v.__docgenInfo={description:"",methods:[{name:"play",docblock:null,modifiers:["static"],params:[{name:"{ canvasElement }",optional:!1,type:null}],returns:null}],displayName:"Interactions"};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`args => <TabsV2 {...args}>
    <TabsV2.List>
  ...
  </TabsV2>`,...v.parameters?.docs?.source}}};const we=["Playground","AppearanceComparison","WithDisabledTab","Stretched","Interactions"];export{h as AppearanceComparison,v as Interactions,f as Playground,V as Stretched,x as WithDisabledTab,we as __namedExportsOrder,je as default};
