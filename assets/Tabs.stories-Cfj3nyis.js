import{r as T,l as c,d as p,j as a}from"./iframe-C0PYgCJh.js";import{B as D}from"./Badge-B8nf5S-f.js";import"./preload-helper-C1FmrZbK.js";import"./Badge.styles-g1u5ZV-a.js";const h=T.createContext({}),E=h.Provider;h.Consumer;function A(){const e=T.useContext(h);if(!e)throw new Error("Tab compound components can't be rendered outside Tabs component");return e}const L=p.div`
  display: flex;
  ${e=>e.$stretch&&c`
