import{r as a,c,s as p,j as e}from"./iframe-B_s_zxyq.js";const d=a.createContext({variant:"standard"}),m=()=>{const o=a.useContext(d);if(!o)throw new Error("List compound components can't be rendered outside List component");return o},f=c.div`
