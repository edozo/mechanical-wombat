import{r as a,d,l as p,j as e}from"./iframe-D_ylYApI.js";const c=a.createContext({variant:"standard"}),m=()=>{const o=a.useContext(c);if(!o)throw new Error("List compound components can't be rendered outside List component");return o},f=d.div`
