import{d as r,r as d,j as t,l as o}from"./iframe-BmeYY3_P.js";import{B as S}from"./ButtonV2-CvWcaeuA.js";import{P as M}from"./Popover-DMQYJBmy.js";import{a as A,L as H}from"./Icons-46xNOSbZ.js";import{L as x}from"./List-CXEe_u7Q.js";import{E as g}from"./EdozoLogo-C0G-8Ve9.js";import"./preload-helper-C1FmrZbK.js";import"./Badge.styles-BF5X1hAD.js";import"./shift-away-CLVi2muT.js";import"./index-Dmycgf77.js";import"./Typography-rSSAwhQU.js";const T=r.div`
...
`,z=({children:e,onClick:s,...i})=>t.jsx(E,{onClick:s,...i,type:"button",children:e});z.__docgenInfo={description:"",methods:[],displayName:"PlatformButton",props:{onClick:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const F=r.div`
...
`,I=d.createContext({appName:"maps"}),O=()=>{const e=d.useContext(I);if(!e)throw new Error("Header compound components can't be rendered outside Header component");return e},P=e=>t.jsx(I.Provider,{value:e,children:t.jsx(D,{children:e.children})});P.__docgenInfo={description:"",methods:[],displayName:"Header",props:{appName:{required:!0,tsType:{name:"union",raw:"'maps' | 'occupiers' | 'insight' | 'reports' | 'extract' | 'edozo'",elements:[{name:"literal",value:"'maps'"},{name:"literal",value:"'occupiers'"},{name:"literal",value:"'insight'"},{name:"literal",value:"'reports'"},{name:"literal",value:"'extract'"},{name:"literal",value:"'edozo'"}]},description:""}}};const U=r.div.withConfig({shouldForwardProp:e=>e!=="appName"})`
  > a {
    position: relative;
    display: flex;
    height: 100%;
    ...
    &:hover {
      ...
      ${e=>e.appName==="reports"&&o`
        ...
        `}
      ${e=>e.appName==="extract"&&o`
          color: ${e.theme.colors.appColors.extract};
        `}
    }
...
`,k=({children:e})=>{const{appName:s}=O();return t.jsx(U,{appName:s,children:e})};k.__docgenInfo={description:"",methods:[],displayName:"MenuItem",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const a=({children:e})=>t.jsx(V,{children:e});a.Item=k;a.PlatformMenu=C;a.PlatformButton=z;a.__docgenInfo={description:"",methods:[{name:"Item",docblock:null,modifiers:["static"],params:[{name:"{ children }",optional:!1,type:null}],returns:null},{name:"PlatformMenu",docblock:null,modifiers:["static"],params:[{name:"{ children }",optional:!1,type:null}],returns:null},{name:"PlatformButton",docblock:null,modifiers:["static"],params:[{name:"{ children, onClick, ...rest }",optional:!1,type:null}],returns:null}],displayName:"Menu"};const W=[{appName:"maps",description:"Create best in class OS mapping with single click technology",url:"https://maps.edozo.com/"},{appName:"occupiers",description:"Create plans and see occupiers for all use classes",url:"https://occupiers.edozo.com/"},{appName:"insight",description:"Find thousands of commercial property transaction comps",url:"https://insight.edozo.com/"},{appName:"reports",description:"Create automated valuation reports",url:"https://reports.edozo.com/"}],u=({appName:e="edozo",logoSection:s,logout:i,isAuthenticated:m,edozoProducts:h=W,children:c})=>t.jsxs(P,{appName:e,children:[s,m&&t.jsxs(a,{children:[c,t.jsxs(a.PlatformMenu,{children:[t.jsx(j,{edozoProducts:h,appName:e}),t.jsx(a.PlatformButton,{onClick:i,"data-testid":"logoutButton",children:t.jsx(H,{size:"small"})})]})]})]});u.__docgenInfo={description:"",methods:[],displayName:"AppHeader",props:{appName:{required:!1,tsType:{name:"union",raw:"'maps' | 'occupiers' | 'insight' | 'reports' | 'extract' | 'edozo'",elements:[{name:"literal",value:"'maps'"},{name:"literal",value:"'occupiers'"},{name:"literal",value:"'insight'"},{name:"literal",value:"'reports'"},{name:"literal",value:"'extract'"},{name:"literal",value:"'edozo'"}]},description:"",defaultValue:{value:"'edozo'",computed:!1}},logout:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},logoSection:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},isAuthenticated:{required:!1,tsType:{name:"boolean"},description:""},edozoProducts:{required:!1,tsType:{name:"Array",elements:[{name:"ProductInfo"}],raw:"ProductInfo[]"},description:"",defaultValue:{value:`[
  {
    appName: 'maps',
