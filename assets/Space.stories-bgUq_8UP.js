import{j as s,r as y,c as m}from"./iframe-CWZzjXvL.js";import{D as i,a as n}from"./DisplayBox.styles-DJd7YVje.js";import{D as l,a as o}from"./DisplayBox-CMf0LUwj.js";import"./preload-helper-C1FmrZbK.js";const D={title:"Theme/Space"},d=[{size:"4px",name:"xxsmall"},{size:"8px",name:"xsmall"},{size:"16px",name:"small"},{size:"24px",name:"base"},{size:"32px",name:"large"},{size:"48px",name:"xlarge"},{size:"64px",name:"xxlarge"}],g=[{size:"1px",name:"3xs"},{size:"2px",name:"2xs"},{size:"4px",name:"xs"},{size:"8px",name:"sm"},{size:"16px",name:"md"},{size:"24px",name:"lg"},{size:"32px",name:"xl"},{size:"48px",name:"2xl"},{size:"64px",name:"3xl"}],r=m.h3`
  margin: 0;
