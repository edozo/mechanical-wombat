import{r as i,d as $,n as k,j as t}from"./iframe-BmeYY3_P.js";import{D as b}from"./DisplayBox.styles-CImO-Z44.js";import{D as C}from"./DisplayBox-DkTF3_KO.js";import{a as j}from"./Typography-rSSAwhQU.js";import"./preload-helper-C1FmrZbK.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=i.forwardRef(({color:e="currentColor",size:o=24,strokeWidth:r=2,absoluteStrokeWidth:n,className:a="",children:s,iconNode:E,...m},I)=>i.createElement("svg",{ref:I,...N,width:o,height:o,stroke:e,strokeWidth:n?Number(r)*24/Number(o):r,className:w("lucide",a),...!s&&!V(m)&&{"aria-hidden":"true"},...m},[...E.map(([W,A])=>i.createElement(W,A)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.510.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p=(e,o)=>{const r=i.forwardRef(({className:n,...a},s)=>i.createElement(z,{ref:s,iconNode:o,className:w(`lucide-${G(u(e))}`,`lucide-${e}`,n),...a}));return r.displayName=u(e),r};/**
 * @license lucide-react v0.510.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],_=p("check",M);/**
 * @license lucide-react v0.510.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 */const F=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],B=p("x",F),q=$.span`
  ...
  svg {
    width: ${e=>e.theme.icons[e.size]};
    height: ${e=>e.theme.icons[e.size]};
  }
