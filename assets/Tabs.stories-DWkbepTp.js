import{r as T,s as c,c as p,j as a}from"./iframe-CAiq36rM.js";import{B as v}from"./Badge-IhHCwlwH.js";import"./preload-helper-PPVm8Dsz.js";import"./Badge.styles-XEGgz2FM.js";const h=T.createContext({}),k=h.Provider;h.Consumer;function x(){const t=T.useContext(h);if(!t)throw new Error("Tab compound components can't be rendered outside Tabs component");return t}const C=p.div`
  display: flex;
  ${({$stretch:t})=>t&&c`
