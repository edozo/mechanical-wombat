import{j as d}from"./iframe-EU7jn1Ok.js";import{L as a}from"./List-bPuUP5Fm.js";import"./preload-helper-C1FmrZbK.js";const u={title:"Components/List",component:a,argTypes:{onClick:{action:"clicked"}},parameters:{backgrounds:{default:"orange"}}},c=({children:m,...p})=>d.jsx(a,{...p,children:m.map(({node:b,disabled:L=!1})=>d.jsx(a.Item,{disabled:L,children:b},Math.random()))}),e=c.bind({});e.args={children:[{node:"First",disabled:!1},{node:"Second",disabled:!1},{node:"Third",disabled:!1}]};const s=c.bind({});s.args={children:[{node:"First",disabled:!1},{node:"Second",disabled:!0},{node:"Third",disabled:!1}]};var n,r,o;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`({
  children,
  ...args
}) => <List {...args}>
    {children.map(({
