import{j as s,r as c,c as t}from"./iframe-B_s_zxyq.js";import{D as i,c as n}from"./DisplayBox.styles-BC6ZC--3.js";import{D as l,a as o}from"./DisplayBox-CiFg4xiC.js";import"./preload-helper-PPVm8Dsz.js";const z={title:"Theme/Space"},x=[{size:"4px",name:"xxsmall"},{size:"8px",name:"xsmall"},{size:"16px",name:"small"},{size:"24px",name:"base"},{size:"32px",name:"large"},{size:"48px",name:"xlarge"},{size:"64px",name:"xxlarge"}],m=[{size:"1px",name:"3xs"},{size:"2px",name:"2xs"},{size:"4px",name:"xs"},{size:"8px",name:"sm"},{size:"16px",name:"md"},{size:"24px",name:"lg"},{size:"32px",name:"xl"},{size:"48px",name:"2xl"},{size:"64px",name:"3xl"}],r=t.h3`
  margin: 0;
