import{r as s,d as a,l as u,j as t}from"./iframe-CAf_PyMu.js";const d=s.createContext({variant:"standard"}),h=()=>{const e=s.useContext(d);if(!e)throw new Error("List compound components can't be rendered outside List component");return e},p=a.div`
