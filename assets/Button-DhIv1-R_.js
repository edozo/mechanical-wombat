import{s as o,c as s,r as t,j as i}from"./iframe-CfiJSd57.js";const n=s.button`
...
`,l=e=>(t.useEffect(()=>{},[]),i.jsx(n,{...e,children:e.children}));l.__docgenInfo={description:`@deprecated This Button component is deprecated and will be removed in the next major version.
Please use the new ButtonV2 component instead.`,methods:[],displayName:"Button",props:{color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:""},variant:{required:!1,tsType:{name:"union",raw:"'standard' | 'outline' | 'ghost'",elements:[{name:"literal",value:"'standard'"},{name:"literal",value:"'outline'"},{name:"literal",value:"'ghost'"}]},description:""},borderRadius:{required:!1,tsType:{name:"union",raw:"'small' | 'standard' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'standard'"},{name:"literal",value:"'large'"}]},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};export{l as B};
