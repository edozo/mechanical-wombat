import{r as T,s as c,c as p,j as a}from"./iframe-Bo766xwD.js";import{B as v}from"./Badge-U4OYY6iI.js";import"./preload-helper-PPVm8Dsz.js";import"./Badge.styles-gQCz1_51.js";const h=T.createContext({}),k=h.Provider;h.Consumer;function x(){const t=T.useContext(h);if(!t)throw new Error("Tab compound components can't be rendered outside Tabs component");return t}const C=p.div`
  display: flex;
  ${({$stretch:t})=>t&&c`
